...
| **v0.8** | **hibiki / 響き** | **🔄 インフラ4/5完了、Phase A分離と外部ベータ残** |
...
- DB は `~/Library/Application Support/jp.zyxcorp.kazane/kazane.db` を引き継ぎ（migration v11 自動適用）
...
| WI-802 | ADR-0013 Phase A — プロセス分離・権限境界の実装 | inbox（agentd分離済み、kazaned/privd残） |
