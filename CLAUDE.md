...
**ブランチ:** `main`  
**最新コミット:** `dfca7b7` feat: v0.5 — domain templates, stale detection, morning toggle, GitHub linkage
...
## 次のマイルストーン: v0.6 akashi / 証し

**目的:** 正式 Evidence Log・RDE Audit フロー — AI生成成果物の意味的ドリフト監査。

主な WI（WI-601、追加予定）:
- Evidence Log の正式化（型・UI・証跡チェーン）
- RDE Audit フロー強化
- レビューチェーン・監査フラグ UI
