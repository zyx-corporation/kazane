...
このリポジトリは公開リポジトリです。`main` ブランチは保護対象として扱い、直接 push や直接変更を行いません。変更は feature branch に作成し、Pull Request を通じてレビュー後に取り込みます。

詳細は [docs/adr/0009-protected-main-branch.md](docs/adr/0009-protected-main-branch.md) を参照してください。

## ライセンス

この公開リポジトリは AGPL-3.0-or-later を前提としつつ、将来的な商用ライセンスオプションを検討中です。

詳細は [LICENSE](LICENSE)、[NOTICE](NOTICE)、[LICENSE-POLICY.md](LICENSE-POLICY.md)、[docs/adr/0007-license-strategy-provisional.md](docs/adr/0007-license-strategy-provisional.md) を参照してください。
